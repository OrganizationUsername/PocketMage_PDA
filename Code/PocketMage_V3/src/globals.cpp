...
// ===================== SYSTEM STATE =====================
Preferences
    prefs;  // NVS preferences // note add power button logic in app + prefs to immediate sleep
...
volatile bool disableTimeout =
    OTA_APP ? true : false;  // Disable timeout globally, OTA_APP: disable timeout by default
...
const String appStateNames[] = {
    ...
    "calendar", "journal", "lexicon", "terminal", "loader"};  // App state names
