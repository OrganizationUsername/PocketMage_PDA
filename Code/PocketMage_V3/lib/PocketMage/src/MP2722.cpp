...
bool MP2722::readReg(uint8_t reg, uint8_t& value) {
  ...
  if (_wire->requestFrom(static_cast<uint8_t>(MP2722_ADDR), static_cast<uint8_t>(1)) != 1)
    return false;
  value = _wire->read();
  return true;
}
...
bool MP2722::setCCMode(uint8_t cc_cfg) {
  if (cc_cfg > 0b101)
    return false;  // invalid per datasheet

  uint8_t reg;
  if (!readReg(MP2722_REG09, reg))
    return false;
...
bool MP2722::getDPDMStatus(MP2722_DPDMStatus& out) {
  ...
  switch (code) {
    case 0b0000:
      out.currentLimitA = 0.5f;
      out.description = "Not started (500mA)";
      break;
    case 0b0001:
      out.currentLimitA = 0.5f;
      out.description = "USB SDP (500mA)";
      break;
    case 0b0010:
      out.currentLimitA = 2.0f;
      out.description = "USB DCP (2A)";
      break;
    case 0b0011:
      out.currentLimitA = 1.5f;
      out.description = "USB CDP (1.5A)";
      break;
    case 0b0100:
      out.currentLimitA = 1.0f;
      out.description = "Divider 1 (1A)";
      break;
    case 0b0101:
      out.currentLimitA = 2.1f;
      out.description = "Divider 2 (2.1A)";
      break;
    case 0b0110:
      out.currentLimitA = 2.4f;
      out.description = "Divider 3 (2.4A)";
      break;
    case 0b0111:
      out.currentLimitA = 2.0f;
      out.description = "Divider 4 (2A)";
      break;
    case 0b1000:
      out.currentLimitA = 0.5f;
      out.description = "Unknown (500mA)";
      break;
    case 0b1001:
      out.currentLimitA = 2.0f;
      out.description = "High-voltage adapter (2A)";
      break;
    case 0b1110:
      out.currentLimitA = 3.0f;
      out.description = "Divider 5 (3A)";
      break;
    default:
      out.currentLimitA = 0.5f;
      out.description = "Reserved/Undefined (500mA)";
      break;
  }
...
bool MP2722::getChargeStatus(MP2722_ChargeStatus& out) {
  ...
  switch (code) {
    case 0b000:
      out.description = "Not charging";
      break;
    case 0b001:
      out.description = "Trickle charge";
      break;
    case 0b010:
      out.description = "Pre-charge";
      break;
    case 0b011:
      out.description = "Fast charge";
      break;
    case 0b100:
      out.description = "Constant-voltage charge";
      break;
    case 0b101:
      out.description = "Charging done";
      break;
    default:
      out.description = "Reserved/Unknown";
      break;
  }
...
bool MP2722::getDPDMStatus(DPDMResult& out) {
  ...
  switch (out.code) {
    ...
    case 0x2:
      out.description = "USB DCP (2A)";
      out.currentLimitA = 2.0;
      break;
    case 0x3:
      out.description = "USB CDP (1.5A)";
      out.currentLimitA = 1.5;
      break;
    case 0x4:
      out.description = "Divider 1 (1A)";
      out.currentLimitA = 1.0;
      break;
    case 0x5:
      out.description = "Divider 2 (2.1A)";
      out.currentLimitA = 2.1;
      break;
    case 0x6:
      out.description = "Divider 3 (2.4A)";
      out.currentLimitA = 2.4;
      break;
    case 0x7:
      out.description = "Divider 4 (2A)";
      out.currentLimitA = 2.0;
    ...
    case 0xE:
      out.description = "Divider 5 (3A)";
      out.currentLimitA = 3.0;
      break;
    default:
      out.description = "Reserved/Invalid";
      out.currentLimitA = 0.0;
      break;
  }
...
void MP2722::printDiagnostics() {
  ...
  // Connection check
  if (isConnected())
    Serial.println(F("MP2722: Connected"));
  else {
    Serial.println(F("MP2722: Not detected"));
    return;
  }
